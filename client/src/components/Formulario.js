    ...
    return (
        ...
        >
            <div className="input">
                ...
                <br />
                <label>
                    {!urlregex.test(inputs.image) ? (
                        <p> !!...la imagen tiene q ser una URL</p>
                    ) : (
                        true
                    )}
                    url de la imagen:
                ...
                <label>
                    ...
                    {error ? (
                        <p>
                            {" "}
                            !!... la puntuacion no puede ser negativa o mayor a
                            100
                        </p>
                    ) : (
                        true
            ...
            <div className="diets">
                {dietas.map((d) => (
                    <div
                        key={d.id}
                        className={
                            inputs.check[d.nombre] ? "activo" : "inactivo"
                        }
                    >
            ...
            <br />
            <br />
            <button className="boton" type="submit" value="Crear ...">
                Agregar receta
            </button>
            <br />
            <br />
